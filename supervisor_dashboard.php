...
<!-- Absen Pribadi & Kalender Global Tim -->
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
    ...
    <?php else: ?>
    <div class="flex items-center justify-between gap-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700 p-5 opacity-75">
        <div class="flex items-center gap-4 min-w-0">
            ...
            <div class="min-w-0"><h3 class="font-bold text-slate-600 dark:text-slate-300">Absen Sekarang</h3><p class="text-xs text-slate-500 dark:text-slate-400 truncate">Akun belum tertaut ke data karyawan.</p></div>
        </div>
