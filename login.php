...
<body class="bg-white dark:bg-slate-900 min-h-screen flex flex-col md:flex-row transition-colors duration-300">
    ...
    <div class="w-full h-72 md:h-auto md:w-[55%] relative flex-shrink-0 bg-cover bg-center z-0" style="background-image: url('assets/images/FotoTeamDinia.png');">
        <!-- Overlay gelap -->
        ...
        <div class="absolute top-6 left-6 sm:top-10 sm:left-10 z-20 flex items-center gap-3 sm:gap-3.5">
            <div class="bg-white/90 backdrop-blur-md p-2 sm:p-2.5 rounded-2xl inline-flex shadow-lg border border-white/20">
                 <img src="Dinia-Logo.png" alt="Dinia Logo" class="h-8 sm:h-10 w-auto" onerror="this.style.display='none'">
            </div>
        ...
        <div class="absolute top-[55%] left-6 sm:left-10 md:left-16 -translate-y-1/2 z-20 pr-12 hidden md:block">
            <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight mb-6 tracking-tight">
                Kelola Absensi <br/>
                Lebih <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-orange-400 to-fuchsia-500">Mudah</span> & <br/>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-orange-400 to-fuchsia-500">Terkontrol</span>.
            </h1>
            <p class="text-slate-300 text-lg leading-relaxed max-w-md font-light">
                Solusi digital terintegrasi untuk rekapitulasi kehadiran dan pemantauan aktivitas karyawan di <br> Dinia House Of Hijab.
            </p>
        </div>
    ...
    <div class="w-full md:w-[45%] flex flex-col justify-center p-8 sm:p-12 lg:p-16 xl:p-20 relative bg-white dark:bg-slate-900 transition-colors duration-300 overflow-y-auto z-20 md:-ml-8 md:rounded-l-[2.5rem] shadow-[-15px_0_40px_rgba(0,0,0,0.15)]">
        
        <div class="w-full max-w-md mx-auto mt-8 md:mt-0">
            <!-- Teks Brand Baru -->
            ...
            <form action="login.php" method="POST" id="loginForm" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="username" id="username" value="<?php echo $prefill_username; ?>" class="block w-full pl-11 pr-4 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 focus:bg-white dark:focus:bg-slate-800 transition-all duration-200" placeholder="Masukkan ID / Username..." required autocomplete="username" <?php echo empty($prefill_username) ? 'autofocus' : ''; ?>>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" id="password" name="password" class="block w-full pl-11 pr-12 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 focus:bg-white dark:focus:bg-slate-800 transition-all duration-200" placeholder="••••••••" required autocomplete="current-password" <?php echo !empty($prefill_username) ? 'autofocus' : ''; ?>>
                ...
                <!-- Tombol Login -->
                <button type="submit" class="w-full py-4 px-4 mt-2 bg-gradient-to-r from-brand-600 to-brand-500 hover:from-brand-700 hover:to-brand-600 disabled:from-slate-400 disabled:to-slate-500 disabled:cursor-not-allowed text-white font-bold rounded-2xl shadow-lg shadow-brand-500/30 transform hover:-translate-y-1 transition-all duration-200 flex items-center justify-center gap-2" <?php echo ($_SESSION['login_attempts'] >= $max_attempts) ? 'disabled' : ''; ?>>
