...
$actionable_notif_count = count($notif_dinas) + $total_acc_gaji;
$total_notif = count($notif_dinas) + count($notif_izin) + ($total_acc_gaji > 0 ? 1 : 0);
...
<head>
    ...
    <title>Dashboard Owner - Absensi Dinia</title>
