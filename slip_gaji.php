<?php
/**
 * SLIP GAJI - HALAMAN UTAMA (Sesuai Demo)
 * Menampilkan daftar karyawan dari semua cabang dengan filter
 */
require 'config.php';
requireAdmin();
...
<div class="flex-1 overflow-y-auto p-6 lg:p-8 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-2xl font-bold text-slate-800 dark:text-white">Pilih Karyawan</h2>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Pilih karyawan dari tabel di bawah ini untuk membuat atau mencetak slip gaji bulanannya.</p>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                    ...
                    <tr id="noResultsRow" class="hidden">
                        <td colspan="7" class="px-6 py-12 text-center text-slate-500 dark:text-slate-400">
                            ...
                            <p>Tidak ada karyawan yang sesuai dengan pencarian atau filter.</p>
                        </td>
                    </tr>
...
function accBulk() {
    ...
    Swal.fire({
        title: 'ACC Slip Terpilih?',
        text: `Anda akan menyetujui ${checkedBoxes.length} slip gaji.`,
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#10b981',
        cancelButtonColor: '#94a3b8',
